...
\afterpage{%    % defer execution until the next page break occurs anyway
  ...
  \begin{table}[h!] % not t or b or p
    ...
    \begin{tabular}{lcccl}
      ...
      3a & \cite{krist05}     & \SI{.0430}{\mu m}--\SI{0.0833}{\mu m} & \SI{1.5}{au} & Apparent \\
      3a &     ---            &         ---           & \SI{0.9}{au}  & Modeled \\
      4 & \cite{schneider14}  & \SI{.2}{\mu m}--\SI{1.05}{\mu m} & \SI{1.2}{au} & Apparent \\
      5 & \cite{macgregor13}  & \SI{1.28}{mm} & $\leq \SI{2}{au}$     & Apparent \\
      6 & This work           & \SI{1.35}{mm} & \SI{1.4 \pm 0.2}{au} & Apparent \\
      \bottomrule
    \end{tabular}
    \caption{MCMC Fitting Results}
