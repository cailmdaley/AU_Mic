...
Comparing the observed aspect ratio to a theoretical model of steady-state size-dependent velocity distributions in the collisional cascade, we find that the total mass of bodies stirring the disk must fall between $\sim \SI{5.4e-5}{M_\earth}$ and $\SI{1.5}{M_\earth}$.  
...
\afterpage{%    % defer execution until the next page break occurs anyway
  ...
  \begin{table}[h!] % not t or b or p
    ...
    \begin{tabular}{lcccl}
      ...
      6 & This work           & \SI{1.35}{mm} & \SI{1.4 \pm 0.2}{au} & Model \\
      \bottomrule
    \end{tabular}
