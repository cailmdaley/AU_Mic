...
Comparing the observed aspect ratio to a theoretical model of steady-state size-dependent velocity distributions in the collisional cascade, we find that the total mass of bodies stirring the disk must fall between $\sim \SI{1.0e-4}{M_\earth}$ and $\SI{1.5}{M_\earth}$.  
