...
We set a $3 \sigma$ upper limit of \SI{0.07}{Jy.km.s^{-1}} on the CO~$\mathrm{J}=2-1$ integrated flux, obtained from an $\SI{8}{\arcsec} \times \SI{8}{\arcsec}$ box around the star between $\SIrange{-10}{10}{km.s^{-1}}$
...
The disk vertical structure is set by the constant aspect ratio $h = H(r)/r$. 
