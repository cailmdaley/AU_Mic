...
\cite{cox85} detect small-scale ($\sim 50\%$) variations over a two-week period between \SIrange{2}{20}{cm}, possibly due to `several independent mini-flares' or rotational modulation of the star.
