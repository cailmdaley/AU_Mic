...
% as $r_{out}$ is defined as the sum of $r_{in}$ and $\Delta r$, the degeneracy between $p$ and $r_{out}$ is actually the superposition of the degeneracies between $p$ and the two radial metrics from which $r_{out}$ is defined.
