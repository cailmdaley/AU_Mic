...
% The peak signal to noise ratio is \textbf{not here yet}.
...
This peak in the millimeter grain surface brightness lies interior to the `birth ring' proposed to explain the the break in the radial surface brightness profile seen at $\sim$ \SIrange{35}{43}{au}  in infrared and visible observations \citep{augereau&beust06,strubbe&chiang06,krist_et_al05}.
