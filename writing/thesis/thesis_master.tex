...
However, because neither detection is significant, it is likely that the discrepancies are caused by fluctuations caused by the RMS noise and that the disk's surface profile is in fact symmetric. 
