...
def main():
    parser = argparse.ArgumentParser(formatter_class = argparse.RawTextHelpFormatter, description= '''Python commands associated with emcee run14, which has 50 walkers and varies the following parameters:
    1)  disk mass
