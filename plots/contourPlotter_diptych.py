...
class Observation:
    ...
    def fill_axis(self):
        ...
        # print(self.cbspace[0] / self.cbspace[1])
        ...
        cbar.set_ticks(np.arange(-10000, 10000, self.cbspace[0]))
...
#     1.4494822607957758e-05, fig=fig, pos=(1, num),
#     text=[[4.6, 4.0, 'AU Mic ALMA 1.4mm'],
#           [4.6, 3.0, 'natural weighting']])
          
band6_natural.im
band9_taper = Observation('../band9/cleans/aumic_band9_taper.fits',    
    1.89688053069e-05, fig=fig, pos=(1, num), text=[
    [4.6, 4.0, 'AU Mic ALMA 1.4mm'],
    [4.6, 3.0, r'$200 k\lambda$ taper']])

plt.savefig('aumic_diptych_all.png')
