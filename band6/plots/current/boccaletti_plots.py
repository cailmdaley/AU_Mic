...
NW = ax1.plot(ra_range, NW_amps[:-1], '--', label='NW')
ax1.fill_between(ra_range, SE_amps-rms, SE_amps+rms, alpha=0.4)
ax1.fill_between(ra_range, NW_amps[:-1]-rms, NW_amps[:-1]+rms, alpha=0.4)
...
ax2.plot(ra_range, NW_mus[:-1], '--', label='NW')
...
ax3.plot(ra_range, NW_disk_FWHM[:-1], '--', label='NW')
...
fig.savefig("boccaletti_plots_all_new_shifted_rms.png", dpi=700)
# plt.show()
