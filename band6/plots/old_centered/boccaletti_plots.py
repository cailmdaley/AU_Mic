...
# image = '../cleans/aumic_marjun_centered_natural'
image = '../cleans/aumic_all_centered_natural'
...
NW = ax1.plot(ra_range, NW_amps, '--', label='NW')
...
ax2.plot(ra_range, NW_mus, '--', label='NW')
...
ax3.plot(ra_range, NW_disk_FWHM, '--', label='NW')
...
fig.savefig("boccaletti_plots_centered_all.png", dpi=700)
plt.show()
