...
all_natural = Observation('../cleans/aumic_all_centered_natural.fits', 
    1.8107746655e-05, fig=fig, pos=(0, num), 
    text=[[4.7, 4.2, 'AU Mic ALMA 1.4mm'],
          [4.7, 3.2, 'natural weighting']])
          
all_200klam = Observation('../cleans/aumic_all_centered_200klam.fits',
    2.15842592297e-05, fig=fig, pos=(1, num), 
    text=[[4.7, 4.2, 'AU Mic ALMA 1.4mm'],
          [4.7, 3.2, r'200 k$\lambda$ taper']])
...
plt.savefig('aumic_centered_all.png', dpi=700)
plt.show()
